...
class State(Enum):
    ...
    w = 5
    fuel = 6
    previous_main_engine_power = 7



XX = State.x.value
YY = State.y.value
X_DOT = State.Vx.value
Y_DOT = State.Vy.value
ALPHA = State.alpha.value
ALPHA_DOT = State.w.value
FUEL = State.fuel.value
PREV_MAIN_POWER = State.previous_main_engine_power.value
...
MAX_GIMBAL_ANGLE = 5 # [deg]
MAX_GIMBAL_VELOCITY = 10 # [?deg/s]
...
ANGULAR_VELOCITY_LAND_LIMIT = 1 # rad/s
Y_LAND_VELOCITY_LIMIT = 20 #10
