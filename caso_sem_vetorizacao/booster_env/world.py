...
class World(EzPickle):
    ...
    def _fireMainEngine(self, power: float, d_alpha: float):
        ...
        #! Ha um bug na posicao do nozzle, mas como nao existe vetorizacao neste caso
        # aplicar a forca no centro da fuselagem tem (quase) o mesmo efeito que aplicar em um bocal balanceado
